...
class CarbonTableColumn {
  ...
  const CarbonTableColumn({required this.title, this.flex = 1});
...
class CarbonDataTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget header = _HeaderRow(columns: columns, size: size);
...
class _HeaderRow extends StatelessWidget {
  const _HeaderRow({required this.columns, required this.size});
  ...
  Widget build(BuildContext context) {
    ...
    return ColoredBox(
      ...
      child: SizedBox(
        ...
        child: Row(
          children: <Widget>[
            for (final CarbonTableColumn column in columns)
              Expanded(
                flex: column.flex,
                child: Padding(
